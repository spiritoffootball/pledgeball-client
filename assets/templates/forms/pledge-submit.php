...
?><form id="pledge_submit" method="post" action="">
	...
	<h3><?php esc_html_e( 'Submit a Standalone Pledge', 'pledgeball-client-side' ); ?></h3>
	...
	<div class="pledge_submit_inner">
		...
		<fieldset>
			<h4><?php esc_html_e( 'Choose Your Pledges', 'pledgeball-client-side' ); ?></h4>
			<p><?php esc_html_e( 'Thank you for supporting PledgeBall and helping the planet!', 'pledgeball-client-side' ); ?></p>
		...
		<fieldset>
			<h4><?php esc_html_e( 'Almost There', 'pledgeball-client-side' ); ?></h4>
			<p>
		...
		<p class="pledge_submit_button">
			<input type="submit" value="<?php echo esc_html__( 'Submit Pledge', 'pledgeball-client-side' ); ?>" id="pledge_submit_button" data-security="<?php echo esc_attr( wp_create_nonce( $this->nonce_ajax ) ); ?>">
