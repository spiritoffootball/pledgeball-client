...
?><form id="event_create" method="post" action="">
	...
	<h3><?php esc_html_e( 'Create an Event', 'pledgeball-client-side' ); ?></h3>
	...
	<div class="event_create_inner">
		...
		<fieldset>
			<h4><?php esc_html_e( 'Your Details', 'pledgeball-client-side' ); ?></h4>
			<p>
				<label class="pledgeball_main_label" for="pledgeball_first_name"><?php esc_html_e( 'First Name', 'pledgeball-client-side' ); ?></label>
				<input type="text" class="pledgeball_main_input" name="pledgeball_first_name" id="pledgeball_first_name" value="">
			</p>
			<p>
				<label class="pledgeball_main_label" for="pledgeball_last_name"><?php esc_html_e( 'Last Name', 'pledgeball-client-side' ); ?></label>
				<input type="text" class="pledgeball_main_input" name="pledgeball_last_name" id="pledgeball_last_name" value="">
			</p>
			<p>
				<label class="pledgeball_main_label" for="pledgeball_email"><?php esc_html_e( 'Email Address', 'pledgeball-client-side' ); ?></label>
				<input type="email" class="pledgeball_main_input pledgeball_input_email" name="pledgeball_email" id="pledgeball_email" value="">
			</p>
			<p>
				<label class="pledgeball_main_label" for="pledgeball_phone"><?php esc_html_e( 'Phone Number', 'pledgeball-client-side' ); ?></label>
				<input type="text" class="pledgeball_main_input pledgeball_input_phone" name="pledgeball_phone" id="pledgeball_phone" value="">
			</p>
		</fieldset>

		<fieldset>
			<h4><?php esc_html_e( 'Event Details', 'pledgeball-client-side' ); ?></h4>
			<p>
				<label class="pledgeball_main_label" for="pledgeball_title"><?php esc_html_e( 'Title', 'pledgeball-client-side' ); ?></label>
				<input type="text" class="pledgeball_main_input pledgeball_input_title" name="pledgeball_title" id="pledgeball_title" value="">
			</p>
			<p>
				<label class="pledgeball_main_label" for="pledgeball_description"><?php esc_html_e( 'Description', 'pledgeball-client-side' ); ?></label>
			...
			<p>
				<label class="pledgeball_main_label" for="pledgeball_start"><?php esc_html_e( 'Start', 'pledgeball-client-side' ); ?></label>
			...
			<p>
				<label class="pledgeball_main_label" for="pledgeball_end"><?php esc_html_e( 'End', 'pledgeball-client-side' ); ?></label>
		...
		<p class="event_create_button">
			<input type="submit" value="<?php echo esc_html__( 'Create Event', 'pledgeball-client-side' ); ?>" id="event_create_button" data-security="<?php echo esc_attr( wp_create_nonce( $this->nonce_ajax ) ); ?>">
